...
A self-serve intake and delivery platform for a marketing agency that rebrands small
Chinese businesses for the American market. A client uploads product photography,
enters their existing Chinese brand name and tagline, picks their industry and the
platform they want to advertise on, and receives a finished advertising video.

This repository is the frontend demo used for the Wharton Global Youth Program
business-plan pitch. There is no backend. The output video is supplied manually.
...
4. **Every state is designed.** Empty, dragging, invalid file, processing, delivered,
   and no-video-yet all have a considered treatment.
